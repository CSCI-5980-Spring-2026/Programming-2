...
In this live programming class, we will begin to define the core structure of a game engine. We will then divide up the monolithic graphics code from the previous class into modular components. 
